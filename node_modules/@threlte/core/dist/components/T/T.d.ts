...
export declare const T: typeof TComp & {
    ...
    ColorManagement: {
        new (options: ComponentConstructorOptions<Props<THREE.ColorManagement>>): SvelteComponent<Props<THREE.ColorManagement>, Events<THREE.ColorManagement>, Slots<THREE.ColorManagement>>;
    };
    MathUtils: {
    ...
    createCanvasElement: {
        new (options: ComponentConstructorOptions<Props<typeof THREE.createCanvasElement>>): SvelteComponent<Props<typeof THREE.createCanvasElement>, Events<typeof THREE.createCanvasElement>, Slots<typeof THREE.createCanvasElement>>;
    };
    readonly REVISION: {
    ...
    readonly ConstantColorFactor: {
        new (options: ComponentConstructorOptions<Props<211>>): SvelteComponent<Props<211>, Events<211>, Slots<211>>;
    };
    readonly OneMinusConstantColorFactor: {
        new (options: ComponentConstructorOptions<Props<212>>): SvelteComponent<Props<212>, Events<212>, Slots<212>>;
    };
    readonly ConstantAlphaFactor: {
        new (options: ComponentConstructorOptions<Props<213>>): SvelteComponent<Props<213>, Events<213>, Slots<213>>;
    };
    readonly OneMinusConstantAlphaFactor: {
        new (options: ComponentConstructorOptions<Props<214>>): SvelteComponent<Props<214>, Events<214>, Slots<214>>;
    };
    readonly NeverDepth: {
        new (options: ComponentConstructorOptions<Props<0>>): SvelteComponent<Props<0>, Events<0>, Slots<0>>;
    };
    ...
    readonly AgXToneMapping: {
        new (options: ComponentConstructorOptions<Props<6>>): SvelteComponent<Props<6>, Events<6>, Slots<6>>;
    };
    readonly AttachedBindMode: {
        new (options: ComponentConstructorOptions<Props<"attached">>): SvelteComponent<Props<"attached">, Events<"attached">, Slots<"attached">>;
    };
    readonly DetachedBindMode: {
        new (options: ComponentConstructorOptions<Props<"detached">>): SvelteComponent<Props<"detached">, Events<"detached">, Slots<"detached">>;
    };
    readonly UVMapping: {
    ...
    readonly RGB_BPTC_SIGNED_Format: {
        new (options: ComponentConstructorOptions<Props<36494>>): SvelteComponent<Props<36494>, Events<36494>, Slots<36494>>;
    };
    readonly RGB_BPTC_UNSIGNED_Format: {
        new (options: ComponentConstructorOptions<Props<36495>>): SvelteComponent<Props<36495>, Events<36495>, Slots<36495>>;
    };
    ...
    readonly LinearDisplayP3ColorSpace: {
        new (options: ComponentConstructorOptions<Props<"display-p3-linear">>): SvelteComponent<Props<"display-p3-linear">, Events<"display-p3-linear">, Slots<"display-p3-linear">>;
    };
    readonly LinearTransfer: {
        new (options: ComponentConstructorOptions<Props<"linear">>): SvelteComponent<Props<"linear">, Events<"linear">, Slots<"linear">>;
    };
    readonly SRGBTransfer: {
        new (options: ComponentConstructorOptions<Props<"srgb">>): SvelteComponent<Props<"srgb">, Events<"srgb">, Slots<"srgb">>;
    };
    readonly Rec709Primaries: {
        new (options: ComponentConstructorOptions<Props<"rec709">>): SvelteComponent<Props<"rec709">, Events<"rec709">, Slots<"rec709">>;
    };
    readonly P3Primaries: {
        new (options: ComponentConstructorOptions<Props<"p3">>): SvelteComponent<Props<"p3">, Events<"p3">, Slots<"p3">>;
    };
    ...
    BatchedMesh: {
        new (options: ComponentConstructorOptions<Props<typeof THREE.BatchedMesh>>): SvelteComponent<Props<typeof THREE.BatchedMesh>, Events<typeof THREE.BatchedMesh>, Slots<typeof THREE.BatchedMesh>>;
    };
    SkinnedMesh: {
    ...
    ShaderLib: {
        new (options: ComponentConstructorOptions<Props<{
            [name: string]: THREE.ShaderLibShader;
            basic: THREE.ShaderLibShader;
            lambert: THREE.ShaderLibShader;
            phong: THREE.ShaderLibShader;
            standard: THREE.ShaderLibShader;
            matcap: THREE.ShaderLibShader;
            points: THREE.ShaderLibShader;
            dashed: THREE.ShaderLibShader;
            depth: THREE.ShaderLibShader;
            normal: THREE.ShaderLibShader;
            sprite: THREE.ShaderLibShader;
            background: THREE.ShaderLibShader;
            cube: THREE.ShaderLibShader;
            equirect: THREE.ShaderLibShader;
            distanceRGBA: THREE.ShaderLibShader;
            shadow: THREE.ShaderLibShader;
            physical: THREE.ShaderLibShader;
    ...
    CompressedCubeTexture: {
        new (options: ComponentConstructorOptions<Props<typeof THREE.CompressedCubeTexture>>): SvelteComponent<Props<typeof THREE.CompressedCubeTexture>, Events<typeof THREE.CompressedCubeTexture>, Slots<typeof THREE.CompressedCubeTexture>>;
    };
    DataTexture: {
