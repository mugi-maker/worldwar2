...
export declare const useInteractivity: () => {
    ...
    initialHits: Object3D<import("three").Object3DEventMap>[];
    hovered: Map<string, import("./types").IntersectionEvent<import("./types").DomEvent>>;
    interactiveObjects: Object3D<import("three").Object3DEventMap>[];
    compute: import("./context").ComputeFunction;
    filter?: import("./context").FilterFunction | undefined;
};
