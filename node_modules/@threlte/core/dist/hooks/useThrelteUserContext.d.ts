...
export declare function useThrelteUserContext<UCT extends UserContextEntry = UserContextEntry>(namespace: string, value: UCT, options?: SetThrelteUserContextOptions): UCT;
export {};
