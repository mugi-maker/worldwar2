<script>import { Color, Vector2, Vector3, ShaderMaterial } from 'three';
import { T, asyncWritable, forwardEventHandlers, useParent, useTask, useThrelte } from '@threlte/core';
...
export let zoom = 1;
export let radius = 0;
export let alphaThreshold = 0;
export let alphaSmoothing = 0.1;
...
export let toneMapped = true;
export let transparent = false;
export let texture = undefined;
export let monochromeColor = undefined;
export let monochromeStrength = undefined;
export let colorProcessingTexture = undefined;
...
$: {
    ...
    const monochromeCheck = (monochromeColor ? 1 : 0) * (monochromeStrength === undefined ? 1 : monochromeStrength);
    for (const value of [
        brightness,
        contrast,
        hue,
