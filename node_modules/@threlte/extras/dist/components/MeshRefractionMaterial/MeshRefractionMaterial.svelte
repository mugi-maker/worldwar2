<script>import { T, useParent, useTask, useThrelte } from '@threlte/core';
...
export let envMap;
export let bounces = 2;
export let ior = 2.4;
export let fresnel = 0;
export let aberrationStrength = 0;
export let color = 'white';
export let fastChroma = true;
...
onMount(() => {
    ...
    if ($parent && $parent instanceof Mesh && $parent.geometry) {
        ...
        material.uniforms.bvh.value.updateFrom(new MeshBVH($parent?.geometry.clone().toNonIndexed(), {
            strategy: SAH
        }));
    }
});
